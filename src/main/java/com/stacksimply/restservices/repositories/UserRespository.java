...
//repository
//git change
import com.stacksimply.restservices.specifications.Specifications;
...
public interface UserRespository extends JpaRepository<User, Long>,JpaSpecificationExecutor<User> {
	...
	SimpleUserProjectionDTO findUserDtlsById(Long id);

	//List<User> findAll(Specifications<User> specs);
